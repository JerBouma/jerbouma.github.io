...
With this information in hand, I can now start collecting data with the [FinanceToolkit](/projects/financetoolkit) package. This can be anything from balance sheet, cash flow and income statements to 100+ financial ratios and indicators, and historical data. Here I initialize the FinanceToolkit with the tickers as found in the FinanceDatabase.
