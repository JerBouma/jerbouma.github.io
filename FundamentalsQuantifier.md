...
description: A tool that allows you to visually compare the fundamentals of over 6,000 companies.
...
* **Financial Ratios**: an extensive list of ratios that covers pretty much all the most used ratios. This
